...
class UserData {
  ...
  UserData.fromParams({this.id, this.email, this.password, this.username, this.phoneno});
  ...
  String toString() {
    ...
    '${json.encode(username)}':'null'},"phoneno":${phoneno != null?
    '${json.encode(phoneno)}':'null'}}';
  }
}

void main(){
  UserData myData = UserData.fromParams(id: 123, email:"email", password: "password",username: "username",phoneno:88335566);
